...
_external_files = [
    Path(sys.prefix, 'etc', 'python_project', 'settings.yml')
]


settings = Dynaconf(
    # Set env `PYTHON_PROJECT_FOO='bar'`，use `settings.FOO` .
    envvar_prefix='PYTHON_PROJECT',
    ...
    # env_switcher='PYTHON_PROJECT_ENV',
